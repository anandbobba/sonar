...
bool whistle_safety_msgs__msg__audio_level__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("whistle_safety_msgs.msg._audio_level.AudioLevel", full_classname_dest, 47) == 0);
  }
  whistle_safety_msgs__msg__AudioLevel * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of AudioLevel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("whistle_safety_msgs.msg._audio_level");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AudioLevel");
