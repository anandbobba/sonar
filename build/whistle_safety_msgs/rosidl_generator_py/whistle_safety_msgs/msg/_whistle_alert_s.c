...
bool whistle_safety_msgs__msg__whistle_alert__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("whistle_safety_msgs.msg._whistle_alert.WhistleAlert", full_classname_dest, 51) == 0);
  }
  whistle_safety_msgs__msg__WhistleAlert * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of WhistleAlert */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("whistle_safety_msgs.msg._whistle_alert");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WhistleAlert");
