...
static const _AudioLevel_type_support_symbol_names_t _AudioLevel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, whistle_safety_msgs, msg, AudioLevel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, whistle_safety_msgs, msg, AudioLevel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, whistle_safety_msgs, msg, AudioLevel)() {
  return &::whistle_safety_msgs::msg::rosidl_typesupport_c::AudioLevel_message_type_support_handle;
}
